...
class ModelLP:
    ...
    def create_model (self):
        ...
        model = gp.Model("LP_"+self.instance) # model constructor
        ...
        contr2 = model.addConstrs((x[i] <= 1 for i in I), name='x <= 1')
        contr3 = model.addConstrs((x[i] >= 0 for i in I), name='x >= 0')
...
if __name__ == '__main__':
    ...
    model = ModelLP(instance_file, capacity, items)
